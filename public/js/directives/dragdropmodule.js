...
.directive("dragmod", ["$rootScope", function ($rootScope) {
...
.directive("dropmod", ['$rootScope', function ($rootScope) {
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            element.bind('drop', function (evt) {
                ...
                $rootScope.$broadcast('dropEvent', $rootScope.draggedElement, attrs.dropmod);
            });
        }
    };
}]);
